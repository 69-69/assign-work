...
/// Search Taxes [TaxMethodSelector]
class TaxMethodSelector extends StatefulWidget {
  final TaxMethodToApply? defaultTaxMethod;
  ...
  @override
  State<TaxMethodSelector> createState() => _TaxMethodSelectorState();
}

class _TaxMethodSelectorState extends State<TaxMethodSelector> {
  ...
  TaxMethodToApply? get _taxMethodToApply => widget.defaultTaxMethod;
  ...
  Widget _taxToApply() {
    final perLineTax = TaxMethodToApply.perLineTax;
    final headerTax = TaxMethodToApply.headerTax;

    return DynamicRadioList(
      title: 'Tax Application Method',
      radiosConfig: [
        RadioGroupConfig(
          key: perLineTax.label,
          defaultSelected: _taxMethodToApply == perLineTax,
        ...
        RadioGroupConfig(
          key: headerTax.label,
          defaultSelected: _taxMethodToApply == headerTax,
      ...
      onChanged: (List<Map<String, dynamic>> data) {
        ...
        WidgetsBinding.instance.addPostFrameCallback((_) {
          setState(() => _isHeaderTax = selectedKey == headerTax.label);
        });
