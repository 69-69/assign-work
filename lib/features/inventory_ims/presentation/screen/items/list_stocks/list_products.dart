...
class _ListProductsState extends State<ListProducts> {
  ...
  Widget _buildCard(BuildContext context, List<Item> products) {
    final inStockProducts = Item.filterItemsByStock(products);
    final outOfStockProducts = Item.filterItemsByStock(
      products,
      inStock: false,
    );
  ...
  void _onChecked(List<Item> products, String id, bool? isChecked) async {
    setState(() {
