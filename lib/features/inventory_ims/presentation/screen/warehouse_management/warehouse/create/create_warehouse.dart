...
import 'package:assign_erp/features/inventory_ims/presentation/screen/warehouse_management/warehouse/widget/warehouse_form_fields.dart';
...
class _CreateWarehouseFormState extends State<_CreateWarehouseForm> {
  ...
  void _updatedWarehouse() {
    ...
    _bloc.add(
      UpdateInventory<Warehouse>(documentId: _warehouseData.id, data: updated),
    );
  }
