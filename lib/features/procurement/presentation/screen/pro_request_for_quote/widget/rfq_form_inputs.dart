...
/// Auto Generate PO & RFQStatus Dropdown TextField [AutoCreateAndRFQStatus]
class AutoCreateAndRFQStatus extends StatelessWidget {
  const AutoCreateAndRFQStatus({
    ...
    required this.onAutoCreateChanged,
  });

  final bool isSelected;
  final void Function(bool) onAutoCreateChanged;
...
class _RFQStatusDropdown extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StaticDropdown<String>(
      ...
      label: 'RFQ Status',
      initialValue: initialValue,
      items: ProcurementStatusHelper.toStringList(type: ProcurementType.rfq),
