...
import 'package:assign_erp/features/procurement/presentation/screen/pro_requisition/create/create_purchase_requisition.dart';
import 'package:assign_erp/features/procurement/presentation/screen/pro_requisition/list/see_requisition_details.dart';
import 'package:assign_erp/features/procurement/presentation/screen/pro_requisition/update/update_purchase_requisition.dart';
...
class _ListPurchaseRequisitionsState extends State<ListPurchaseRequisitions> {
          ...
          ProcurementsLoaded<PurchaseRequisition>(data: var results) =>
            results.isEmpty
                ? context.buildAddButton(
                    ...
                    onPressed: () => context.openAddPurchaseRequisite(),
                  )
  ...
  Widget _buildCard(
    ...
    return DynamicDataTable(
      ...
      onOptButtonTap: (row) async => await _onPrintRFQ(requisitions, row.first),
  ...
  AuditProcurement<PurchaseRequisition> _updateHistory(
    ...
    return AuditProcurement<PurchaseRequisition>(
      ...
      log: {
        'history': [
          ...requisite.history.map((e) => e.toMap()), // keep old logs
          AuditLog(
            action: action,
