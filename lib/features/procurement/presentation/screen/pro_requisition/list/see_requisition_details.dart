...
extension PRDetails on BuildContext {
  ...
  AuditProcurement<PurchaseRequisition> _updateHistory(requisite) {
...
class _PRInfoPage extends StatelessWidget {
  ...
  List<PRLineItem> get _items => _requisite?.lineItems ?? [];
  ...
  Widget _buildHeader(BuildContext context) {
    ...
    final headerItems = <(String, String)>[
      ...
      ('Priority', _requisite?.priority.getValue.toUpperAll ?? 'N/A'),
      ('Department', _requisite!.departmentCode.toTitle),
      ('Request By', _requestBy.toUpperAll),
    ];
