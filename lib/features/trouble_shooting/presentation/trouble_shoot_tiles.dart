    ...
    final tilesData = [
      {
        ...
        'route': RouteNames.diagnoseIssues,
        'param': {},
      ...
      },
      {
        ...
        'route': RouteNames.allTenantWorkspaces,
        'param': {},
      ...
      },
      {
        ...
        'route': RouteNames.manageSubscriptions,
        'param': {},
...
// Get name from enum
String _getName(e) => EnumUtil<TroubleShootPermission>(e).getName;
