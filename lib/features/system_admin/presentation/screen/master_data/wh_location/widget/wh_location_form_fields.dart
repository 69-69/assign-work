...
import 'package:assign_erp/features/system_admin/presentation/screen/master_data/wh_bin/widget/location_type_dropdown.dart';
import 'package:assign_erp/features/system_admin/presentation/screen/master_data/wh_location/widget/zone_type_dropdown.dart';
    ...
    FieldGroupConfig(
      ...
      customBuilder: ({required initialData, required onChanged}) {
        return LocationTypeDropdown(
          initialValue: '$initialData'.toSeparate,
          onChanged: onChanged,
        );
      },
    ),
